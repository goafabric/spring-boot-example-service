...
public class SpelTest {
    ...
    public void test() {
        ...
        final Expression expression = new SpelExpressionParser().parseExpression("T(org.goafabric.spring.boot.exampleservice.crossfunctional.TenantRequestContext).getTenantId()");
